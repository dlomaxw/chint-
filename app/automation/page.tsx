...
import { Cpu, Network, Shield, Smartphone, ArrowRight, CheckCircle2 } from "lucide-react"
  ...
  const automationProducts = [
    {
      ...
      image: "/chint-plc-controller.jpg",
      features: ["Modular Design", "High Speed", "Multiple I/O", "Programming Software"],
      category: "Controllers",
    },
    {
      id: 2,
      name: "HMI Touch Panels",
      description: "Human-machine interface panels for system control",
      image: "/chint-hmi-panel.jpg",
      features: ["Color Display", "Touch Interface", "Data Visualization", "Remote Access"],
      category: "HMI",
    },
    {
      id: 3,
      name: "Variable Frequency Drives",
      description: "Motor speed control and energy saving solutions",
      image: "/chint-vfd-drive.jpg",
      features: ["Energy Efficient", "Smooth Control", "Protection Features", "Easy Setup"],
      category: "Drives",
    },
    {
      id: 4,
      name: "Industrial Sensors",
      description: "Precision sensors for automation applications",
      image: "/chint-industrial-sensors.jpg",
      features: ["High Accuracy", "Robust Design", "Multiple Types", "Easy Integration"],
      category: "Sensors",
    },
  ]
      ...
      <section className="bg-[#0B1C2C] text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            >
              Industrial <span className="text-[#C8A96A]">Automation</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Intelligent control systems and advanced robotics engineering to power the next generation of Ugandan manufacturing.
            </motion.p>
      ...
      <section className="py-24 bg-white border-b border-[#0B1C2C]/5">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
            {[
              { icon: Cpu, title: "Smart Control", desc: "Intelligent automation cores" },
              { icon: Network, title: "Connectivity", desc: "Full network integration" },
              { icon: Shield, title: "Reliability", desc: "Industrial-grade durability" },
              { icon: Smartphone, title: "Remote Access", desc: "Cloud & mobile monitoring" },
            ].map((feat, idx) => (
      ...
      <section className="py-24 bg-[#F8F9FB]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-16 text-center">
            <h2 className="text-4xl lg:text-5xl font-black text-[#0B1C2C] mb-4">Automation Catalog</h2>
